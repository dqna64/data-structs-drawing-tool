...
const nodeCircVar = {
    ...
    showUnmaterialised: {
        ...
        opacity: 0.8,
        pathLength: 1,
        transition: { duration: DURATION, type: "spring", bounce: 0.5 }
    },
    showMaterialised: {
        x: - 15,
        y: - 15,
...
const linkLineVar = {
    ...
    show: (linkLineSvg: string) => ({
        ...
        pathLength: 1,
        opacity: 1,
        transition: { duration: DURATION, delay: 0.05, ease: "easeOut" }
    }),
}
...
const linkArrowVar = {
    ...
    show: (linkArrowSvg: string) => ({
        ...
        opacity: 1,
        transition: { duration: DURATION, delay: 0.08, ease: "easeOut" }
    }),
}
